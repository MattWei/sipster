...
exports = {
  ...
  //getSipSystem: addon.getSipSystem,

  //initPlatform: addon.initPlatform,
  //startLocalRecord: addon.startLocalRecord,
  //stopLocalRecord: addon.stopLocalRecord,
  //startLocalPlay: addon.startLocalPlay,
  //stopLocalPlay: addon.stopLocalPlay,
